...
export default function BookEdit() {
  ...
  const [formData, setFormData] = useState({
    ...
    cover_photo: null,
    description: "",
    _method: "PUT" // Assuming you want to use PUT method for update
  });
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      cover_photo: bookData.cover_photo, // Assuming cover_photo is a file or URL
      description: bookData.description,
      _method: "PUT" // Ensure the method is set for update
      });
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/admin/books"); // Redirect to the books list after creation
    } catch (error) {
      console.log(error);
