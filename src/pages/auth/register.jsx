...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        (msg && (msg.toLowerCase().includes("already") || msg.toLowerCase().includes("exist"))) ||
        (emailError && emailError.toLowerCase().includes("taken"))
      ) {
        setError("Account already registered");
      } else {
        setError(msg || emailError || "Registration failed");
      }
    } finally {
      setLoading(false);
    }
